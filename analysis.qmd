...
flows_hdigroups %>%
  ...
  print() %>%
  {
    ggplot(.) +
      ...
      annotate_360_glasslight(x = 1, y = Inf, label = "Origin<br>country",
        vjust = "inward", fontface = "bold", size = 7) +
      annotate_360_glasslight(x = 2, y = Inf, label = "Destination<br>country",
        vjust = "inward", fontface = "bold", size = 7) +
      theme_360() +
      theme(
      ...
      labs(
        ...
        subtitle = paste(
          "Although students come from countries across the development spectrum,",
          "they tend to visit **highly developed countries** to study.",
          sep = "<br>"),
        caption = paste(
